resource "aws_ssm_parameter" "bastion_sg_id" {
  ...
  type  = "String"
  value = module.bastion_sg.sg_id # module should have output declaration
}
...
resource "aws_ssm_parameter" "rabbitmq_sg_id" {
  ...
  type  = "String"
  value = module.rabbitmq_sg.sg_id # module should have output declaration
}
...
resource "aws_ssm_parameter" "payment_sg_id" {
  ...
  type  = "String"
  value = module.payment_sg.sg_id # module should have output declaration
}
